...
final class KdpConfig
{
    ...
    public function __construct(
        ...
        public readonly ?string $printBackCover,
        public readonly ?string $printSpineColor,
    ...
    public static function fromConfig(array $config): self
    {
        ...
        return new self(
            ...
            printBackCover: self::optionalString($print['back_cover'] ?? null),
            printSpineColor: self::optionalString($print['spine_color'] ?? null),
